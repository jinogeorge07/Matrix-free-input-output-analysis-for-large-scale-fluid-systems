...
if size(U_mf,1) ~= 3*N
    error('Unexpected U_mf size: expected 3*N rows, got %d',size(U_mf,1));
end
...
%% ========================= RESHAPE MODES ================================
% Convert weighted SVD vectors back to physical response/forcing modes
